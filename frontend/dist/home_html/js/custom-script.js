...
(function($) {
    ...
    if ($(selector).length && typeof Parallax !== 'undefined') {
	...
	if ($('.dish-gallery-slider').length && $.fn.owlCarousel) {
		try {
			...
			console.warn('Dish Gallery Carousel initialization failed:', e);
		}
	}
	...
	if ($('.testimonial-slider').length && $.fn.owlCarousel) {
		try {
			...
			console.warn('Testimonials Carousel initialization failed:', e);
		}
	}

	//Gallery Carousel
	if ($('.image-gallery-slider').length && $.fn.owlCarousel) {
		try {
			...
			console.warn('Gallery Carousel initialization failed:', e);
		}
	}

	// Testimonials Carousel
	if ($('.testimonials-section .testi-top').length && $('.testimonials-section .testi-thumbs').length && $.fn.owlCarousel) {
		try {
			...
			console.warn('Testimonials Carousel sync initialization failed:', e);
		}
	}
